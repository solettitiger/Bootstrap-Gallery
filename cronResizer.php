...
// # Einstellungen
// ##################################################################
define("IMG_ROOT_PATH",array(__DIR__.'/images/')); // Pfade, die rekursive nach Bildern durchsucht werden
define("IMG_TYPE",array('jpg','gif','png'));
define("IMG_MAX_WIDTH",2000);
define("IMG_MAX_HEIGHT",2000);
define("IMG_MAX_DPI",150);
define("IMG_ORIG_PATH",'/.orig/'); // Subdirectory das je Pfad, wo größere Bilder gefunden werden, angelegt wird. Die Originale werden dort hinein kopiert. 
define("IMG_CROP",false); //soll das verkleinerte Bild dann noch auf IMG_MAX_WIDTH:IMG_MAX_HEIGHT zugeschnitten werden?
